...
<div id="shortcode-generator">
    ...
    <div class="shortcode-content">     
        ...
        <div class="content"><select id="ccr-shortcodes" data-placeholder="' . __("Choose a shortcode", 'jwtheme') .'">
        <option value=""> - Select a shortcode - </option>';
        
        foreach( $jwtheme_shortcodes as $shortcode => $options ){
...
<link rel="stylesheet" href="<?php echo get_template_directory_uri(); ?>/lib/shortcodes/css/font-awesome.min.css" />
<link rel="stylesheet" href="<?php echo get_template_directory_uri(); ?>/lib/shortcodes/css/style.css" />

<!--scripts-->
<script src="<?php echo get_template_directory_uri(); ?>/lib/shortcodes/js/popup.js"></script>
...
<?php echo $shortcode_html . $html_options;  ?>
    ...
    <div id="shortcode-content">
        ...
        <div class="label"><label id="option-label" for="shortcode-content"><strong><?php echo __( 'Content: ', 'jwtheme' ); ?></strong> </label></div>
    ...
    <a class="btn" id="add-shortcode"><?php echo __( 'Add Shortcode', 'jwtheme' ); ?></a>
