...
/*------------------------ Post Navigation ------------------------*/
jQuery('.post-navigation div.prev a').addClass("prev");
jQuery('.post-navigation div.next a').addClass("next");
...
jQuery('.top-section').css({'height': jQuery(window).height()});


// comments button
 jQuery('#comments .form-submit').addClass('btn btn-sm btn-default full-width btn-effect');
