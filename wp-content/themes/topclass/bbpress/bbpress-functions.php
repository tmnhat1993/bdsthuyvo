...
function jeweltheme_bbp_search_form(){
    ?>
...
add_action( 'bbp_template_before_single_forum', 'jeweltheme_bbp_search_form' );
 ...
 */
function jeweltheme_bbp_filter_search_results( $r ){
...
add_filter( 'bbp_after_has_search_results_parse_args' , 'jeweltheme_bbp_filter_search_results' );


function jeweltheme_add_extra_contactmethod( $contactmethods ) {
// Add new ones
...
add_filter('user_contactmethods', 'jeweltheme_add_extra_contactmethod');


//function to shorten freshness display from say '1 month, 2 weeks' to '1 month'
function jeweltheme_short_freshness_time( $output) {
	$output = preg_replace( '/, .*[^ago]/', ' ', $output );
	return $output;
}
add_filter( 'bbp_get_time_since', 'jeweltheme_short_freshness_time' );
add_filter('bp_core_time_since', 'jeweltheme_short_freshness_time');
