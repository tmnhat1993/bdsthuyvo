...
function jeweltheme_wp_awesome_faq_admin_notice() {
    ...
    if ( ! get_user_meta($user_id, 'jeweltheme_ignore_notice') ) {
        ...
        printf(__('<h2 style="font-size: 20px; color: #5FA52A; font-weight: normal; margin-bottom: 10px; margin-top: 5px;">
            ...
            Check all of our <a href="https://jeweltheme.com/cat/wordpress-themes/" target="_blank">Free and Premium WordPress Themes</a> and <a href="https://jeweltheme.com/cat/wordpress-plugins/" target="_blank">WordPress Plugins </a> <a style="float: right;" href="%1$s">X</a>'), '?jeweltheme_ignore=0');
        echo "</p></div>";
    }
}
...
add_filter("plugin_action_links_" . plugin_basename( __FILE__ ), 'wp_awesome_faq_plugin_action_links',10,2);
...
function wp_awesome_faq_plugin_action_links($links) {
    ...
    if ($this_plugin) {
        ...
        $upgrade_link=
            '<a href="'.WP_AWESOME_FAQ_PRO_URL.'" style="color:#fff; padding:3px 10px; background: red;" target="_blank">Upgrade</a>';
...
// Plugin Row Meta
add_filter( 'plugin_row_meta', 'wp_awesome_faq_plugin_row_meta', 10, 2 );

function wp_awesome_faq_plugin_row_meta( $links, $file ) {

    if ( strpos( $file, 'wp-awesome-faq/index.php' ) !== false ) {
        ...
        $more_links = array(
                ...
                'upgrade' => '<a href="'.WP_AWESOME_FAQ_PRO_URL.'" style="color:#fff; padding:3px 10px; background: red;" target="_blank">Upgrade</a>'
